...
<div class="row">
        ...
        ?>
            <div class="col-md-3">
                <div class="card mt-3" style="background-color:#94B49F; border-radius:30px" >
                    <img src="../fotonya/<?=$dt_produk['foto_produk']?>" class="card-img-top" width="180px" height="260px" style="border-radius:30px 30px 0 0">
                    <div class="card-body">
                        ...
                        <a href="ubah_produk.php?id_produk=<?=$dt_produk['id_produk']?>" class="btn" style="background-color:#ECB390; color:black">Ubah<a>
    ...
    <div>
        <br>
        <a href="tambah_produk.php" class="btn" style="background-color:#ECB390;color:black">Tambah Produk</a>
    </div>
<?php
include "footer.php";
?>